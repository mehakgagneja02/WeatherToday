   ...
   private ArrayList<Weather> weatherArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       listView = findViewById(R.id.idListView);
        ...
        URL weatherUrl = Network.buildUrlForWeather();
    ...
    private class FetchWeatherDetails extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            try {
                weatherSearchResults = Network.getResponseFromHttpUrl(weatherUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    private ArrayList<Weather> parseJSON(String weatherSearchResults) {
        ...
        if(weatherSearchResults != null) {
            try {
                ...
                if(weatherArrayList != null) {
                    Adapter weatherAdapter = new Adapter(this, weatherArrayList);
